...
**Current Version**: 1.0.0-alpha — read `STATE.json` for the machine-readable oracle.
**Current Phase**: 1.0.0 — AI Workflow Foundation
**Next**: Complete Phase 3 (View Filter Hardening) → v1.2.0
...
- **Phase 3: View Filter Hardening** — 🔄 active on `checkpoint/fix-cross-view-list-moves` (3 of 7 checkpoints done)

## Active Branch

`checkpoint/fix-cross-view-list-moves` — fixing cross-view list move projection consistency (Phase 3, checkpoint 6)
